...
for(const file of ["app.js","production-client.js","api/workflow.js","api/listings.js","api/upload.js","api/media.js","api/ai-analyze.js","api/health.js","api/auth.js","api/v2/me.js","lib/schema.cjs","lib/r2.cjs","lib/storage.cjs","lib/materials.cjs","lib/ai.cjs","lib/intelligence/schema.cjs","lib/intelligence/circuit.cjs","lib/intelligence/providers.cjs","lib/intelligence/engine.cjs","lib/foundation/authz.cjs","lib/foundation/rbac.cjs"]){const syntax=spawnSync(process.execPath,["--check",file],{stdio:"inherit"});if(syntax.status!==0)process.exit(syntax.status??1);}
