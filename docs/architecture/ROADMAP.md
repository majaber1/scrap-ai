...
## Phase 0 — Recovery, truth, AI fix (NOW)
...
- **Exit:** See audit scoreboard — all mandatory PASS.  
...
Tenancy, RBAC, material taxonomy, sites, org categories, audit, outbox, TS frontend shell, migrate V1 users/listings. Exit: foundations live without destroying production data.
